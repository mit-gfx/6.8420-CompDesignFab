...
void test(std::string testcase) {
	...
	std::string stl_filename = std::string(PROJECT_SOURCE_DIR) + "/data/assignment2/BBW/" + testcase + ".stl";
	std::string handle_filename = std::string(PROJECT_SOURCE_DIR) + "/data/assignment2/BBW/" + testcase + "_handles.txt";
	...
	// output to file
	std::string output_filename = std::string(PROJECT_SOURCE_DIR) + "/data/assignment2/BBW/results/" + testcase + "_weights.txt";
